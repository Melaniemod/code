...
if algo == 'lr':
    ...
    # todo train data size: (312437, 133465)
    #  test data size: (156063, 133465)
    #  remove empty fields [25, 131235, 35, 367, 2, 800, 961, 2, 2, 4, 2, 4, 2, 14, 5, 5]
    #  {'field_sizes': [25, 131235, 35, 367, 2, 800, 961, 2, 2, 4, 2, 4, 2, 14, 5, 5],
